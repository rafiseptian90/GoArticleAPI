...
type ArticleRepositoryInterface interface {
	...
	GetArticlesByTags(tags []string) []Article
	GetTrendingArticlesByTags(tags []string) []Article
	GetLatestArticlesByTags(tags []string) []Article
	GetBestArticlesByTags(tags []string) []Article
	GetArticle(articleSlug string) (map[string]interface{}, error)
	StoreArticle(articleRequest *ArticleRequest) error
	UpdateArticle(articleID int, articleRequest *ArticleRequest) error
